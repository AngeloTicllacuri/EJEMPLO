...
if tipo==1: 
	print("el precio del libro es:", preciolenguaje,"soles")
if tipo==2: 
	print("el precio del libro es:", preciohistoria,"soles")
if tipo==3: 
	print("el precio del libro es:", preciobiologia,"soles")
if tipo==4: 
	print("el precio del libro es:", preciomatematicas,"soles") 
...
print("Hola  que frutas desea llevar, tenemos:") 
print("manzana")
print("pera")
print("platano")
print("sandia") 
...
panfrances=3
pancaracol=1
print("Asigna cuantos panes se vendieron hoy")
